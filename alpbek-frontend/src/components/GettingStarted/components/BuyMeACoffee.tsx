...
export const BuyMeACoffee = () => {
	...
	const paymentContractHash = '63dd9fa7abc0dfead30bc483ca845e1349eb010aa69f154a8674da53b422e69e';
	const clickRef = useClickRef();
	const activeAccount = clickRef?.getActiveAccount();
	const publicKey = activeAccount?.public_key
		? activeAccount.public_key
		: '0202f51799b825ee1121bf6a8b86b916944e0bbaf93f8fef837331fd4299ff1eb04c';
	...
	const handleSignTransaction = async () => {
		...
		const deploy = await makeTransferDeploy(publicKey, '100000000000', chainName, paymentContractHash);
		clickRef
			?.send(deploy, sender)
			...
			<Section withBackground>
				<table>
					<tbody>
						...
						<tr>
							<StyledTD>How much alpbek:</StyledTD>
							<td>
								<i>500 alpbek</i>
							</td>
						</tr>
						<tr>
							<StyledTD>Account that will be alpbek:</StyledTD>
							<td>
