			...
			<StyledWrapper>
				<InfoContainer>
					<StyledInfo>
						...
						<GreetingText>Welcome to alpbek </GreetingText>
						<KillerAppText>If you haven&#39;t gotten alpbek, you don&#39;t know what you&#39;re missing!</KillerAppText>
						<LearnMoreButton onClick={handleReadMore}>Get Totally alpbek!</LearnMoreButton>
					</StyledInfo>
				</InfoContainer>
			</StyledWrapper>
		</Container>
